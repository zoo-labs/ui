...
export const DialogRoot = Root`
  ...
  it("should handle real-world @hanzo/ui patterns from registry files", async () => {
    // This test captures all the actual import patterns found in the @hanzo/ui registry
...
export const Button = SlotPrimitive.Slot`
  ...
  it("should handle the special sheet.tsx pattern from registry", async () => {
    // In @hanzo/ui, sheet.tsx imports from react-dialog instead of a dedicated sheet package
...
export const FormControl = SlotPrimitive.Slot`
  ...
  it("should handle all 26 packages used in @hanzo/ui registry", async () => {
