...
export class RegistryParseError extends RegistryError {
  ...
  constructor(public readonly item: string, parseError: unknown) {
    ...
    super(message, {
      ...
      context: { item },
      suggestion:
        "The registry item may be corrupted or have an invalid format. Please make sure it returns a valid JSON object. See https://ui.hanzo.ai/schema/registry-item.json.",
    })
...
export class ConfigMissingError extends RegistryError {
  constructor(public readonly cwd: string) {
    ...
    super(message, {
      ...
      context: { cwd },
      suggestion:
        "Run 'npx hanzo-ui@latest init' to create a components.json file, or check that you're in the correct directory.",
    })
...
export class ConfigParseError extends RegistryError {
  constructor(public readonly cwd: string, parseError: unknown) {
    ...
    super(message, {
      ...
      context: { cwd },
      suggestion:
        "Check your components.json file for syntax errors or invalid configuration. Run 'npx hanzo-ui@latest init' to regenerate a valid configuration.",
    })
