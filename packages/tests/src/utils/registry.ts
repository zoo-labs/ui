            ...
            files: [
              {
                ...
                type: "registry:ui",
                content:
                  "export function AlertDialog() { return <div>AlertDialog Component from Registry Hanzo</div> }",
              },
            ],
          },
          {
            ...
            files: [
              {
                ...
                type: "registry:ui",
                content:
                  "export function Button() { return <div>Button Component from Registry Hanzo</div> }",
              },
            ],
          },
        ])
