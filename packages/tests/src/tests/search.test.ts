...
describe("shadcn search", () => {
  it("should search items from shadcn registry", async () => {
    ...
    const output = await npxHanzo(fixturePath, ["search", "@shadcn"])
  ...
  it("should list from configured registry", async () => {
    ...
    const output = await npxHanzo(fixturePath, ["search", "@one"])
  ...
  it("should handle non-existent registry gracefully", async () => {
    const fixturePath = await createFixtureTestDirectory("next-app-init")
    const output = await npxHanzo(fixturePath, ["search", "@unknown"])
  ...
  it("should handle authentication for secured registries", async () => {
    ...
    const output = await npxHanzo(fixturePath, ["search", "@two"])
  ...
  it("should handle missing environment variables for authenticated registry", async () => {
    ...
    const output = await npxHanzo(fixturePath, ["search", "@auth"])
  ...
  it("should handle namespace with special characters", async () => {
    const fixturePath = await createFixtureTestDirectory("next-app-init")
    const output = await npxHanzo(fixturePath, ["search", "@test-123"])
  ...
  it("should handle empty registry name", async () => {
    const fixturePath = await createFixtureTestDirectory("next-app-init")
    const output = await npxHanzo(fixturePath, ["search", "@"])
  ...
  it("should handle validation errors", async () => {
    ...
    const output = await npxHanzo(fixturePath, ["search", "@bad"])
  ...
  it("should handle network timeouts gracefully", async () => {
    ...
    const output = await npxHanzo(fixturePath, ["search", "@timeout"])
  ...
  it("should handle partial components.json without other required fields", async () => {
    ...
    const output = await npxHanzo(fixturePath, ["search", "@one", "@two"])
  ...
  it("should handle typos in search (fuzzy matching)", async () => {
    ...
    // Test dialog typo
    const dialogOutput = await npxHanzo(fixturePath, [
      "search",
      "@shadcn",
      "--query",
      "dialg",
    ...
    // Test alert typo
    const alertOutput = await npxHanzo(fixturePath, [
      "search",
      "@shadcn",
      "--query",
      "alrt",
  ...
  it("should handle case-insensitive search", async () => {
    ...
    const output1 = await npxHanzo(fixturePath, [
      "search",
      "@shadcn",
      "--query",
      "BUTTON",
    ])
    const output2 = await npxHanzo(fixturePath, [
      "search",
      "@shadcn",
      "--query",
      "button",
    ])
    const output3 = await npxHanzo(fixturePath, [
      "search",
      "@shadcn",
      "--query",
      "BuTtOn",
