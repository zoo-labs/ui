...
import { createFixtureTestDirectory, npxHanzo } from "../utils/helpers"
...
describe("shadcn view", () => {
  it("should view a single component from shadcn registry", async () => {
    ...
    const output = await npxHanzo(fixturePath, ["view", "button"])
  ...
  it("should view multiple components from shadcn registry", async () => {
    const fixturePath = await createFixtureTestDirectory("next-app-init")
    const output = await npxHanzo(fixturePath, ["view", "button", "card"])
  ...
  it("should view component with registry dependencies", async () => {
    const fixturePath = await createFixtureTestDirectory("next-app-init")
    const output = await npxHanzo(fixturePath, ["view", "alert-dialog"])
  ...
  it("should view component from configured registry", async () => {
    ...
    const output = await npxHanzo(fixturePath, ["view", "@one/foo"])
  ...
  it("should view component with nested registry dependencies", async () => {
    ...
    const output = await npxHanzo(fixturePath, ["view", "@one/bar"])
  ...
  it("should view component with cross-registry dependencies", async () => {
    ...
    const output = await npxHanzo(fixturePath, ["view", "@one/complex"])
  ...
  it("should handle authentication for secured registries", async () => {
    ...
    const output = await npxHanzo(fixturePath, ["view", "@two/secure-item"])
  ...
  it("should handle non-existent component gracefully", async () => {
    const fixturePath = await createFixtureTestDirectory("next-app-init")
    const output = await npxHanzo(fixturePath, ["view", "non-existent"])
  ...
  it("should handle non-existent registry gracefully", async () => {
    const fixturePath = await createFixtureTestDirectory("next-app-init")
    const output = await npxHanzo(fixturePath, ["view", "@unknown/component"])
  ...
  it("should handle invalid URL format", async () => {
    const fixturePath = await createFixtureTestDirectory("next-app")
    const output = await npxHanzo(fixturePath, ["view", "not-a-valid-url"])
  ...
  it("should handle missing environment variables for authenticated registry", async () => {
    ...
    const output = await npxHanzo(fixturePath, ["view", "@auth/secure-item"])
  ...
  it("should view authenticated dependencies when directly requested", async () => {
    ...
    const output = await npxHanzo(fixturePath, ["view", "@two/item"])
  ...
  it("should handle namespace with special characters", async () => {
    const fixturePath = await createFixtureTestDirectory("next-app-init")
    const output = await npxHanzo(fixturePath, ["view", "@test-123/component"])
  ...
  it("should handle empty component name in namespace", async () => {
    const fixturePath = await createFixtureTestDirectory("next-app-init")
    const output = await npxHanzo(fixturePath, ["view", "@shadcn/"])
  ...
  it("should handle double namespace", async () => {
    const fixturePath = await createFixtureTestDirectory("next-app-init")
    const output = await npxHanzo(fixturePath, ["view", "@@test/component"])
  ...
  it("should error when viewing non-existent item from configured registry", async () => {
    ...
    const output = await npxHanzo(fixturePath, ["view", "@one/does-not-exist"])
