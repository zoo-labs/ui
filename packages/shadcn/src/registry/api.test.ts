...
const server = setupServer(
  ...
  http.get(`${REGISTRY_URL}/registries.json`, () => {
    return HttpResponse.json({
      "@shadcn": "https://ui.hanzo.ai/r/styles/{style}/{name}.json",
...
describe("getRegistry", () => {
  ...
  it("should distinguish between URL and registry name", async () => {
    ...
    const registryUrl = "https://ui.hanzo.ai/registry.json"
    ...
    const mockConfig = {
      ...
      registries: {
        "@shadcn": {
          url: "https://ui.hanzo.ai/{name}.json",
        },
      },
    } as any
  ...
  it("should handle complex registry configurations", async () => {
    ...
    try {
      ...
      expect(result.registries?.["@shadcn"]).toBe(
        "https://ui.hanzo.ai/r/styles/{style}/{name}.json"
      )
