...
import { Home, Search, Mail, Calendar, Settings, User, Music, Video, Image } from "lucide-react"
...
export default function DockWithSeparatorsDemo() {
  return (
    <div className="relative flex h-[500px] w-full items-end justify-center rounded-lg border bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <Dock className="mb-8">
        <DockItem tooltip="Finder" onClick={() => console.log("Finder clicked")}>
          <Home className="h-6 w-6" />
        </DockItem>
        <DockItem tooltip="Safari" onClick={() => console.log("Safari clicked")}>
        ...
        <DockItem tooltip="Videos" onClick={() => console.log("Videos clicked")}>
          <Video className="h-6 w-6" />
        </DockItem>
        <DockItem tooltip="Photos" onClick={() => console.log("Photos clicked")}>
