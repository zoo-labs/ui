...
const Button3D = React.forwardRef<HTMLButtonElement, Button3DProps>(
  ({
    ...
    const updateTilt = React.useCallback((e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    const buttonStyle: React.CSSProperties = {
      ...
      transform: tiltOnHover
        ...
        : isPressed ? 'translateY(1px)' : undefined,
...
const Button3DPreset = {
  Hero: React.forwardRef<HTMLButtonElement, Omit<Button3DProps, 'variant' | 'size' | 'depth'>>(
    (props, ref) => (
      <Button3D
        ref={ref}
        variant="gradient"
  ...
  CTA: React.forwardRef<HTMLButtonElement, Omit<Button3DProps, 'variant' | 'size' | 'depth'>>(
    (props, ref) => (
      <Button3D
        ref={ref}
        variant="neon"
  ...
  Glass: React.forwardRef<HTMLButtonElement, Omit<Button3DProps, 'variant' | 'size' | 'depth'>>(
    (props, ref) => (
      <Button3D
        ref={ref}
        variant="glass"
  ...
  Minimal: React.forwardRef<HTMLButtonElement, Omit<Button3DProps, 'variant' | 'size' | 'depth'>>(
    (props, ref) => (
      <Button3D
        ref={ref}
        variant="ghost"
  ...
  Danger: React.forwardRef<HTMLButtonElement, Omit<Button3DProps, 'variant' | 'size' | 'depth'>>(
    (props, ref) => (
      <Button3D
        ref={ref}
        variant="destructive"
...
const Button3DLoading = React.forwardRef<HTMLButtonElement, Button3DProps & { loading?: boolean }>(
