...
interface AppSwitcherNavigationBarProps extends React.HTMLAttributes<HTMLElement> {
  apps: App[]
  currentApp?: string
  onAppSwitch?: (appId: string) => void
}

const AppSwitcherNavigationBar = React.forwardRef<HTMLElement, AppSwitcherNavigationBarProps>(
