...
function useCursorState() {
  ...
  const updateHoverState = useCallback((isHovering: boolean, cursorType: CursorState['cursorType'] = 'default') => {
    setCursorState(prev => ({
      ...prev,
      isHovering,
      cursorType
...
export function AnimatedCursor({
  ...
  }, [mounted, hideOnTouch, isTouch, updatePosition, updateHoverState, updateClickState])
