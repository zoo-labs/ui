  ...
  ],
  {
    variants: {
      ...
      depth: {
        ...
        default: "before:translate-x-1 before:translate-y-1 after:translate-x-2 after:translate-y-2",
...
const Text3D = React.forwardRef<HTMLSpanElement, Text3DProps>(
  ({
    ...
    const updateRotation = React.useCallback((e: React.MouseEvent<HTMLSpanElement>) => {
    ...
    const handleMouseEnter = React.useCallback((e: React.MouseEvent<HTMLSpanElement>) => {
      setIsHovered(true)
      onMouseEnter?.(e)
    }, [onMouseEnter])

    const handleMouseLeave = React.useCallback((e: React.MouseEvent<HTMLSpanElement>) => {
      setIsHovered(false)
      resetRotation()
      onMouseLeave?.(e)
    }, [onMouseLeave, resetRotation])

    const handleMouseMove = React.useCallback((e: React.MouseEvent<HTMLSpanElement>) => {
      if (rotateOnHover) {
        updateRotation(e)
      }
      onMouseMove?.(e)
...
const Text3DAnimated = React.forwardRef<HTMLSpanElement, Text3DProps & {
  ...
  ({
    ...
    return <Text3D ref={ref} {...props}>{children}</Text3D>
  }
)
...
const Text3DPreset = {
  Hero: React.forwardRef<HTMLSpanElement, Omit<Text3DProps, 'variant' | 'size' | 'depth'>>(
    (props, ref) => (
      <Text3D
        ref={ref}
        variant="rainbow"
  ...
  Neon: React.forwardRef<HTMLSpanElement, Omit<Text3DProps, 'variant' | 'size' | 'depth'>>(
    (props, ref) => (
      <Text3D
        ref={ref}
        variant="neon"
  ...
  Metallic: React.forwardRef<HTMLSpanElement, Omit<Text3DProps, 'variant' | 'size' | 'depth'>>(
    (props, ref) => (
      <Text3D
        ref={ref}
        variant="metallic"
  ...
  Fire: React.forwardRef<HTMLSpanElement, Omit<Text3DProps, 'variant' | 'size' | 'depth'>>(
    (props, ref) => (
      <Text3D
        ref={ref}
        variant="fire"
  ...
  Glass: React.forwardRef<HTMLSpanElement, Omit<Text3DProps, 'variant' | 'size' | 'depth'>>(
    (props, ref) => (
      <Text3D
        ref={ref}
        variant="glass"
...
const Text3DFloating = React.forwardRef<HTMLSpanElement, Text3DProps & {
