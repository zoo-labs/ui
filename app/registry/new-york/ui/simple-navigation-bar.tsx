...
export interface SimpleNavigationBarProps extends React.HTMLAttributes<HTMLElement> {
  logo?: React.ReactNode
  items?: Array<{ label: string; href: string }>
}

const SimpleNavigationBar = React.forwardRef<HTMLElement, SimpleNavigationBarProps>(
