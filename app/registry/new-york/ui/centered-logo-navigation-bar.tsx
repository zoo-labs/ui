...
export interface CenteredLogoNavigationBarProps extends React.HTMLAttributes<HTMLElement> {
  logo?: React.ReactNode
  leftItems?: Array<{ label: string; href: string }>
  rightItems?: Array<{ label: string; href: string }>
}

const CenteredLogoNavigationBar = React.forwardRef<HTMLElement, CenteredLogoNavigationBarProps>(
