...
export interface CollaborationNavigationBarProps extends React.HTMLAttributes<HTMLElement> {
  title?: string
  collaborators?: Array<{ name: string; avatar?: string }>
}

const CollaborationNavigationBar = React.forwardRef<HTMLElement, CollaborationNavigationBarProps>(
