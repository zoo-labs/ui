...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-8">
  <div className="p-4 border rounded-lg">
    ...
    <p className="text-sm text-muted-foreground">Typewriter, word reveal, letter shuffle, gradient, and glitch effects</p>
  </div>
  <div className="p-4 border rounded-lg">
    <h3 className="font-semibold">Animated Number</h3>
    <p className="text-sm text-muted-foreground">Count up/down with formatting, decimals, and easing options</p>
  </div>
  <div className="p-4 border rounded-lg">
    <h3 className="font-semibold">Animated List</h3>
    <p className="text-sm text-muted-foreground">Stagger animations, reorderable items, virtualized for performance</p>
  </div>
  <div className="p-4 border rounded-lg">
    <h3 className="font-semibold">Animated Background</h3>
    <p className="text-sm text-muted-foreground">Gradient shifts, blob animations, wave patterns, parallax layers</p>
  </div>
  <div className="p-4 border rounded-lg">
    <h3 className="font-semibold">Animated Icon</h3>
    <p className="text-sm text-muted-foreground">Morph between icons, SVG path animations, hover effects</p>
  </div>
  <div className="p-4 border rounded-lg">
    <h3 className="font-semibold">Reveal Animation</h3>
    <p className="text-sm text-muted-foreground">Scroll-triggered reveals, multiple directions, stagger children</p>
  </div>
  <div className="p-4 border rounded-lg">
    <h3 className="font-semibold">Pulse Animation</h3>
    <p className="text-sm text-muted-foreground">Attention-grabbing pulse with customizable intensity and patterns</p>
  </div>
</div>
