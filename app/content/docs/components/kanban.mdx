...
<ComponentPreview name="kanban-demo" description="A fully functional Kanban board with drag-and-drop" />
...
<ComponentPreview name="kanban-basic" description="A simple Kanban board with basic functionality" />

### Kanban with Labels

<ComponentPreview name="kanban-labels" description="Kanban board showcasing label functionality" />

### Project Management Board

<ComponentPreview name="kanban-project" description="A project management Kanban board with all features" />
