...
<Callout>
  **Note:** This feature is currently experimental. Help us improve it by
  ...
  out to us](https://github.com/hanzo-ui/ui/discussions).
</Callout>

You can use the `hanzo` CLI to run your own component registry. Running your own registry allows you to distribute your custom components, hooks, pages, and other files to any React project.
...
Registry items are automatically compatible with the `hanzo` CLI and `Open in v0`.
