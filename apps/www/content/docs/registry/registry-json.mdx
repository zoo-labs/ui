...
You can see the JSON Schema for `registry.json` [here](https://ui.hanzo.com/schema/registry.json).
...
The `items` in your registry. Each item must implement the [registry-item schema specification](https://ui.hanzo.com/schema/registry-item.json).
