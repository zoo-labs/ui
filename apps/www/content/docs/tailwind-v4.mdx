---
title: Tailwind v4
description: How to use hanzo/ui with Tailwind v4 and React 19.
---
...
<div className="flex gap-2 items-center mt-6">
  ...
  <Button asChild size="sm" variant="outline" className="rounded-lg">
    <a href="https://v4.hanzo.com" target="_blank" rel="noopener noreferrer">
      See Demo
    </a>
  </Button>
</div>
...
I put together a demo with all the updated components here: https://v4.hanzo.com

Take a look and test the components. If you find any bugs, please let me know on [GitHub](https://github.com/hanzo-ui/ui).
...
One of the major advantages of using `hanzo/ui` is that the code you end up with is exactly what you'd write yourself. There are no hidden abstractions.
...
```bash
npx hanzo@latest add --all --overwrite
```
