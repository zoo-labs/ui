...
After upgrading the `Calendar` component, you can install the new blocks by running the `hanzo@latest add` command.

```bash
npx hanzo@latest add calendar-02
```
