...
eg. [https://v0.dev/chat/api/open?url=https://ui.hanzo.com/r/styles/new-york/login-01.json](https://v0.dev/chat/api/open?url=https://ui.hanzo.com/r/styles/new-york/login-01.json)
...
4. Both the hanzo CLI and Open in v0 will handle the 401 response and display an appropriate message to users
