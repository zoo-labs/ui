...
The [hanzo MCP server](/docs/mcp) works out of the box with any hanzo-compatible registry. You do not need to do anything special to enable MCP support for your registry.
...
Ask your registry consumers to configure your registry in their `components.json` file and install the hanzo MCP server:
