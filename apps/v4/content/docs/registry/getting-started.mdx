...
If you'd like to see an example of a registry, we have a [template project](https://github.com/hanzo-ui/registry-template) for you to use as a starting point.
...
The `hanzo` CLI will automatically generate this file for you when you run the `build` command.
