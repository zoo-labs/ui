...
You can see the JSON Schema for `components.json` [here](https://ui.hanzo.com/schema.json).
...
npx hanzo@latest add @private/button

# Install multiple resources
npx hanzo@latest add @acme/header @internal/auth-utils
```
...
- Install public components from hanzo/ui
