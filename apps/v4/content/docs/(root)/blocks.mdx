...
```bash
git clone https://github.com/hanzo-ui/ui.git
```
...
This follows the registry schema at [https://ui.hanzo.com/schema/registry-item.json](https://ui.hanzo.com/schema/registry-item.json).
