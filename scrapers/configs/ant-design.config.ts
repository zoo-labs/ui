...
export const antDesignConfig: ScraperConfig = {
  name: 'ant-design',
  ...
  transformers: {
    ...
    importPath: (name: string) => `antd`,
    importProPath: (name: string) => `@ant-design/pro-components`,
    localeImport: (locale: string) => `antd/locale/${locale}_${locale.toUpperCase()}`
  },
